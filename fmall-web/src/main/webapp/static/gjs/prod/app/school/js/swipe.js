    ...
    Swipe.prototype = {
        ...
        animate: function(){
            ...
            setTimeout(function(){
                ...
                _this.moveing = false;
                __this = (isRevert ? curObj : nextObj);
                __this.removeAttr('style').attr('class', 'cur').siblings().removeAttr('style').removeAttr('class');
                console.log('aaa',__this);
            }, 300);

            ////////////////////////////////////
            //翻页控制音频//
            if(nextObj[0].id=="hehe"){
                document.getElementById("mp3Btn").src="music/shentai.m4a";
                document.getElementById("sound").style.display='block';
                document.getElementById("soundBox").style.display='none';
                return false
            }else{
                document.getElementById("mp3Btn").src="";
                return false
            }
            ////////////////////////////////////
        ...
        translate: function(dis, win, isRevert){
            ...
            if(index < 0) return;//index += slideLength;
            if(index > slideLength - 1) return;//index = 0;
