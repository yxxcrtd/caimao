(function(){
    ...
    Swipe.prototype = {
        init: function(){
            ...
            doms = $(this.slides[this.cur]).find(".loadBtn")[0].parentNode;
            debug = $("#debug");
        debug.html("init"+$(doms).position().top);
        },
        start: function(e){
        ...
        setTimeout(function(){debug.html("end"+$(doms).position().top+"|"+doms.style.top)},3000);
        },
        reset: function(){
            console.log('reset');
        },
