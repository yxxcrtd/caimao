...
SWFUpload.prototype.getFlashHTML = function() {
	return ['<object style="left:0;top:0;" id="', this.movieName, '" type="application/x-shockwave-flash" data="', this.settings.flash_url, '" width="', '100%', '" height="', '100%', '" class="swfupload">', '<param name="wmode" value="', this.settings.button_window_mode, '" />', '<param name="movie" value="', this.settings.flash_url, '" />', '<param name="quality" value="high" />', '<param name="menu" value="false" />', '<param name="allowScriptAccess" value="always" />', '<param name="flashvars" value="' + this.getFlashVars() + '" />', "</object>"].join("");
};
...
(function(c) {
	...
	var a = {
		onDialogOpen: function() {
			var d = this.settings;
			this.queueData.errorMsg = "上传失败请确认图片格式是否正确:";
