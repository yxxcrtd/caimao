var profile = (function(){
    return {
        ...
        releaseDir: "E:/release", // where the release position
        releaseName: "lib",
        action: "release",
        ...
        layers: {
            ...
            'min/Brokerage': {include: ['app/controllers/Brokerage'], includeLocales: ['zh-cn']},
            ...
            'min/P6': {include: ['app/controllers/P6'], includeLocales: ['zh-cn']},
            'min/P8': {include: ['app/controllers/P8'], includeLocales: ['zh-cn']},
            'min/P10': {include: ['app/controllers/P10'], includeLocales: ['zh-cn']},
