define([
	...
	'app/views/financing/LoanInfoPanel',
	'app/views/financing/LoanConfirmPanel',
	...
	'dojo/domReady!'
		...
		cookie, date, stamp, Prompt, LoanInfoPanel, LoanConfirmPanel, LoanSuccessPanel, lang, RSA, JSON, App) {
				...
				Ajax.post(Global.baseUrl + '/financing/loan/data', {
					...
					if (response.success) {
						...
						content1.setValues({
							...
							productMinLoan: data.productMinLoan || 1000000, // TODO
							repayStart: data.productRepayStart,
							productSettleMode: data.productSettleMode
						});
						//content1.set("list",response.data);
					} else {
			...
			if (content1.get('list')) {
				...
				if (ratioItem) {
					content1.setValues({
						...
						'rate': ratioItem.interest_day_rate,
