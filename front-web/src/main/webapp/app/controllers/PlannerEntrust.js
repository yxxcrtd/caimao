...
function(Helper,win , dom , on ,Ajax,Global, DateUtil, Grid, Store,query,ComboBox,Memory,DateRange,DateQuickSelect){
	...
	function initView(){
		//左侧菜单
		query("ul.list-lside li:nth-child(2) > a").addClass("active");
		...
		historyDateQuickSelect = new DateQuickSelect({
			...
			onClick: function() {
				...
				historyEntrustGrid.setQuery({
		   			'entrust_timestart':data.start_date,
		   			'entrust_timeend':data.end_date,
	...
	function queryEntrust(){
		...
		var gridLayout = [[
		     		    {'name': '委托编号', 'field': 'entrust_no', styles: 'text-align: center;', noresize: true, width: '10%'},
		     		    {'name': '委托时间', 'field': 'entrust_time', styles: 'text-align: center;', noresize: true, width: '10%',formatter:formatTime}, 
		     		    ...
		     		    {'name': '委托价格', 'field': 'entrust_price', styles: 'text-align: right;', noresize: true, width: '10%',formatter:formatPriceNotDivide},
		     		    {'name': '委托数量', 'field': 'entrust_amount', styles: 'text-align: right;', noresize: true, width: '10%'},
		...
		var store = new Store({
   	        target: Global.baseUrl + '/stock/father/curentrust',
	...
	function queryHistoryEntrust(){
		...
		var gridLayout = [[
		     		    {'name': '委托编号', 'field': 'entrust_no', styles: 'text-align: center;', noresize: true, width: '10%'},
		     		    {'name': '委托时间', 'field': 'entrust_date', styles: 'text-align: center;', noresize: true, width: '12%',formatter:formatDate}, 
		     		    {'name': '证券代码', 'field': 'stock_code', styles: 'text-align: center;', noresize: true, width: '10%'},
		     		    {'name': '证券名称', 'field': 'stock_name', styles: 'text-align: center;', noresize: true, width: '10%'},
		     		    {'name': '委托状态', 'field': 'entrust_status_name', styles: 'text-align: center;', noresize: true, width: '10%'},
		     		    {'name': '买卖方向', 'field': 'entrust_direction_name', styles: 'text-align: center;', noresize: true, width: '10%'},
		...
		var store = new Store({
   	        target: Global.baseUrl + '/stock/father/historyentrust',
   	        allowNoTrailingSlash: true
   		});
