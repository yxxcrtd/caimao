...
define([
	...
	function setQuery(params, pageNumber, isFirst) {
		    destoryHisContractList();
	        if (isFirst) {
	            params.start = 0;
	        }
	        setHisContractList(params, pageNumber, isFirst);
	}
	
	function setHisContractList(params, pageNumber, isFirst) {
        when(Data.getHisContracts(params, true), function (data) {
            if (isFirst) {
	...
	function destoryHisContractList(){
