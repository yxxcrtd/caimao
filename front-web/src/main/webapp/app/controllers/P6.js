define([
    ...
    var protocolToggler = dom.byId('protocoltoggler'),
        ...
        productDetails,
        ratioObj,
        product_id = Product.getProductId(10),
        win,
        slideContainer,
        slideContainer1,
        loanFixPanel,
    ...
    function initView() {
        ...
        all([promise1, promise2]).then(function(results){
            ...
            var minDepoist = 10000;
            var maxDepoist = 200000000;
            if(product.prodLoanRatioMax != 0){
                minDepoist = product.prodAmountMin / product.prodLoanRatioMax;
            }
            if(product.prodLoanRatioMin != 0){
                maxDepoist = product.prodAmountMax / product.prodLoanRatioMin;
            }
