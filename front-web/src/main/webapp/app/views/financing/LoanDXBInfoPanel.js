define([
    ...
    'dojo/text!./templates/LoanDXBInfoPanel.html'
], function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Global, query, 
		DisplayBox, TextBox, Button, dom, domConstruct, on, DateUtil, LoanDXBProtocolPanel, template){
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    	...
    	_setRepayStartAttr: function(value) {
    		...
    		this.productRepayStartNode.innerHTML = value;
    	},
    	...
    	_setRateAttr: function(value) {
    		...
    		this.rateNode.innerHTML = Global.formatAmount(value);
    	},
    	...
    	render: function() {
    		...
    		me.protocolPanel = new LoanDXBProtocolPanel();
    	...
    	getData: function() {
    		return {
    			cash_amount: this.get('availableAmount'),
