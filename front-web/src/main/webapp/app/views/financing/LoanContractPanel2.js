define([
    ...
    'dojo/store/Memory',
    'dojo/text!./templates/LoanContractPanel2.html'
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, ViewMixin], {
        ...
        _setNeedAmountAttr: function(value) {
            this.needAmount = value;
            this.needAmountNode.innerHTML = Global.formatAmount(value);
            this.needAmountNode.innerHTML = value;
        },

        _setAvailableAmountAttr: function(value) {
            this.availableAmountNode.innerHTML = Global.formatAmount(value);
            var needAmount = this.depositAmount + this.interestAmount - value;
        ...
        _setInterestAmountAttr: function(value) {
            ...
            this.interestAmountNode.innerHTML = Global.formatAmount(value, 3);
        },
