define([
    ...
    'dojo/text!./templates/ChangeTradePwdPanel.html'
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    		...
    		me.oldPwdFld = new TextBox({
     		...
     		me.newPwdFld = new TextBox({
				...
				validates: [{
					...
					pattern: function() {
						return this.get('value') != me.oldPwdFld.get('value');
					},
					message: '新密码与旧密码一致，请重新输入'
				}],
				type: 'password',
                showStrength: true,
				onKeyUp: function(e) {
    	...
    	getData: function() {
    		return {
    			old_trade_pwd: this.oldPwdFld.get('value'),
    			new_trade_pwd: this.newPwdFld.get('value')
    		};
    	},
