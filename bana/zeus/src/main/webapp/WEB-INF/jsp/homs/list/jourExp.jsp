...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
    ...
    <Worksheet ss:Name="Sheet1">
        <Table ss:ExpandedColumnCount="15" ss:ExpandedRowCount="${list.totalCount + 1}" x:FullColumns="1"
            ...
            <Row>
                ...
                <Cell><Data ss:Type="String">HOMS主账号</Data></Cell>
                <Cell><Data ss:Type="String">HOMS子帐号</Data></Cell>
                <Cell><Data ss:Type="String">管理子帐号</Data></Cell>
                ...
                <Cell><Data ss:Type="String">会计时间</Data></Cell>
            </Row>
            <c:forEach items="${list.getItems()}" var="u">
                <Row>
                    ...
                    <Cell><Data ss:Type="String">${u.homsFundAccount}</Data></Cell>
                    <Cell><Data ss:Type="String">${u.homsCombineId}</Data></Cell>
                    <Cell><Data ss:Type="String">${u.homsManageId}</Data></Cell>
                    ...
                    <Cell><Data ss:Type="String"><c:if test="${u.seqFlag == 1}">增加</c:if><c:if test="${u.seqFlag == 2}">减少</c:if></Data></Cell>
                    ...
                    <Cell><Data ss:Type="String">${u.workDate}</Data></Cell>
                </Row>
            </c:forEach>
        </Table>
