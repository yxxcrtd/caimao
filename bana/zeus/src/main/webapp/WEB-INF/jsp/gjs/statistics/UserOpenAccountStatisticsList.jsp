...
<div class="body_container">
    ...
    <div class="main_content">
        <div class="container">
            <h4 class="heading">用户开户统计</h4>
            <jsp:include page="/WEB-INF/jsp/include/tpl_menu_page.jsp"/>
            <form method="post" class="form-inline" action="/gjs/statistics/openAccount" name="searchForm">
            ...
            <div style="padding: 5px 0;">南交所开户数量：<b>${njsOpenAccountCount}</b>；南交所累计开户数：<b>${njsOpenAccountTotalCount}</b></div>
            <div style="padding: 5px 0 15px;">上金所开户数量：<b>${sjsOpenAccountCount}</b>；上金所累计开户数：<b>${sjsOpenAccountTotalCount}</b></div>
