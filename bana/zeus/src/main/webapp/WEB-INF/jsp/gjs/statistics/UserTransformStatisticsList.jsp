...
<div class="body_container">
    ...
    <div class="main_content">
        <div class="container">
            <h4 class="heading">用户转化统计</h4>
            <jsp:include page="/WEB-INF/jsp/include/tpl_menu_page.jsp"/>
            <form method="post" class="form-inline" action="/gjs/statistics/transform" name="searchForm">
            ...
            <div style="padding: 5px 0;">南交所首日转换率：<b>${njsCount1}</b>；南交所3日转换率：<b>${njsCount3}</b>；南交所7日转换率：<b>${njsCount7}</b></div>
            <div style="padding: 5px 0 15px;">上金所首日转换率：<b>${sjsCount1}</b>；上金所3日转换率：<b>${sjsCount3}</b>；上金所7日转换率：<b>${sjsCount7}</b></div>
