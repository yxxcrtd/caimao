...
<div class="body_container">
    ...
    <div class="main_content">
        <div class="container">
            ...
            <form id="save" method="post" action="/ybk/article/save" class="form-horizontal" style="width: 90%">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="exchangeId" class="form-control input-sm">
                            <option value="0" <c:if test="${articleDetail.exchangeId == 0}">selected</c:if> >无</option>
