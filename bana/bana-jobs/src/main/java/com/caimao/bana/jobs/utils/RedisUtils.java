...
public class RedisUtils {
	...
	public void set(Integer index, final String key, final String value) {
		getRedisTemplate(index).execute(new RedisCallback<Object>() {
			public Long doInRedis(RedisConnection connection)
					throws DataAccessException {
	...
	public void hDel(Integer index, final String key, final String field) {
		getRedisTemplate(index).execute(new RedisCallback<Object>() {
			@Override
			public Object doInRedis(RedisConnection conn)
					throws DataAccessException {
	...
	public Boolean setNX(Integer index, final String key, final String value) {
		return (Boolean)getRedisTemplate(index).execute(new RedisCallback<Object>() {
			@Override
			public Object doInRedis(RedisConnection conn)
					throws DataAccessException {
				return conn.setNX(key.getBytes(), value.getBytes());
			}
		});
	}
}
