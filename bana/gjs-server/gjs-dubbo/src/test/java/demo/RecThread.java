...
public class RecThread implements Runnable {
     ...
     * 行情连接地址
     */
    public static String MARKET_IP = "183.62.138.188";
    /**
     * 行情连接端口
     */
    public static int MARKET_PORT = 6081;
    /**
     * 登陆行情服务器的用户名
     */
    public static String MARKET_LOGIN_USER = "163";
    /**
     * 登陆行情服务器的密码
     */
    public static String MARKET_LOGIN_PWD = "111111";
