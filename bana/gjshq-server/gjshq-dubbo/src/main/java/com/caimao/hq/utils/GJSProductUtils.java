...
public class GJSProductUtils {
    ...
    public   List<Product> convertTreeMapToList(LinkedHashMap<String,Map<String, Object>> map){
        ...
        if(null!=map) {
            ...
            while (titer.hasNext()) {
                try{
                    java.util.Map.Entry ent = (java.util.Map.Entry) titer.next();
                    String keyt = ent.getKey().toString();
                    java.util.Map<String, Object> valuet = (java.util.Map) ent.getValue();
                    if (null != valuet) {
    ...
    private  void initHoliday(){
        ...
        try {
            ...
            String strTradeTime="";
           // String strTradeTime = gjsHolidayService.queryGjsHolidayByExchangeAndHoliday("NJS", DateUtils.getNoTime("yyyyMMdd"));
            ...
            // String strTradeTimeSJS = gjsHolidayService.queryGjsHolidayByExchangeAndHoliday("SJS", DateUtils.getNoTime("yyyyMMdd"));
