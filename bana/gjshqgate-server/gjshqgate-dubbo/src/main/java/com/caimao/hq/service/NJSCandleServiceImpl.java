...
public class NJSCandleServiceImpl  extends CandleUtils implements INJSCandleService {
    ...
    @Value("${njs.multisnap.time.begin}")
    protected String njsMultiSnapBeginTime;

    @Value("${njs.multisnap.time.end}")
    protected String njsMultiSnapEndTime;
...
//        }
    ...
    private void setSelectSnapshotFiveDate(TradeAmountReq tradeAmountReq, String nowDate,String afterDate) {
        ...
        if (null != tradeAmountReq && !StringUtils.isBlank(nowDate)) {
            ...
            if(!StringUtils.isBlank(njsMultiSnapBeginTime)){
                beginStrBuffer.append(njsMultiSnapBeginTime);
            }else{
            ...
            if(!StringUtils.isBlank(njsMultiSnapEndTime)){
                endStrBuffer.append(njsMultiSnapEndTime);
            }else{
