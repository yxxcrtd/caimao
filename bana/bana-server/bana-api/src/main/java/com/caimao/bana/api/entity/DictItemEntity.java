...
public class DictItemEntity implements Serializable {
    private static final long serialVersionUID = -8353395337707687726L;
    private String dictItemCode;
    private String dictEntryCode;
    private String dictItemName;
    private String lifecycle;
    private String platform;
    private Long dictItemOrder;
    ...
    public Long getDictItemOrder() {
        return this.dictItemOrder;
    }

    public void setDictItemOrder(Long dictItemOrder) {
